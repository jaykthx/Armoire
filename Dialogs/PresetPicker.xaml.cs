...
namespace Armoire.Dialogs
{
    ...
    {
        public List<string> presets = new() { "Eye Texture Swap", "Contact Lenses", "Hair", "Body", "Hands", "Head Accessory", "Face Accessory", "Chest Accessory", "Back Accessory" };
        public List<string> presets_item = new() { "Head Accessory", "Face Accessory", "Chest Accessory", "Back Accessory" };
        ...
        {
            if ((preset.subid == 6 || preset.subid == 24) && wizCheck)
            {
